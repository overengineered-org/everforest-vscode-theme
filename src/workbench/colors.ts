...
export function createWorkbenchColors(palette: Palette, themePreferences: ThemePreferences) {
  ...
  const workbenchColors: Record<string, string> = {
    ...
    "editorBracketMatch.border": readableTextPalette.aqua,
    "editorBracketMatch.background": "#00000000",
    "editorBracketMatch.foreground": readableTextPalette.fg,
    ...
    "scmGraph.historyItemHoverDeletionsForeground": readableWorkbenchAccentColors.red,
